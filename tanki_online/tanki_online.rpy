...
def vipil_tabletki():
    label akt1:
        ...
        name_vladP
        "Думаю{w}, за ту хуйню которую он сделал, мы имеем права позаимствовать три ноута"
        ...
        slYA "Привет, вы, наверное, только что приехали?"
        ...
        slYA "Дай подумать{w}, карта есть{w}, но она у Ольги Дмитриевны, а она сейчас занята"
        name_vladP "Блять"
        slYA "Пойдём со мной{w}, покажу вам лагерь, пока Ольга Дмитриевна занята"
        ...
        slYA "Вообще{w}, полное имя Славяна, но все меня Славей звоут"
        name_vladP "Ебать прикол{w}, у нас тоже свой Славя есть{w}, только с хуем"
        th "Она смущённо усмехнулась"
        slYA "Так{w}, идите на площадь{w}, я преоденусь и встречу вас там"
        ...
        slYA "О{w}, вы уже здесь"
        slYA "Ольга Дмитриевна свободна{w}, пойдём до её домика"
        ...
        old "Привет{w}, вы новенькие?"
        name_vladP "ДА БЛЯТЬ НЕТ{w}, у нас навигатор...сломался{w}, нам нужна карта"
        old "ааа{w}, хорошо, у меня есть как раз{w}, держите"
        name_ii "Ого{w}, вот так просто"
        old "А вы торопитесь?"
        name_ii "Ну..{w} да нет"
        old "Ну так может останетесь на ночь у нас{w}, а то уставшие, а завтра полные сил поедите"
        ...
        lena "Слава"
        lena "Можешь трахнуть меня?"
        th "У Сявы зазвенело в ушах и ноги стали ватными"
        name_ii "Чего?"
        lena "Ну мы пойдём ко мне в домик и потрахаемся"
        name_ii "Аааа{w}, мы же с тобой только познакомились"
        lena "Ну смотри, ты мне понравился и я тебе{w}, завтра ты уедешь{w}, так может оторвёмся?"
        ...
        slYA "Меня без одежды"
        name_vladP "Нее{w}, я только пришёл"
        slYA "Я заметила тебя ещё когда заходила в воду"
        name_vladP "ЧЕГО?{w} И почему ничего не сказала?"
        slYA "Нуу{w}, за мной ещё не подглядывали мальчики"
        ...
        alisa "Я кое-что спёрла из столовой"
        ...
        name_vladM "Ого"
        alisa "Так и быть{w}, за твоё молчание предлагаю выпить вместе"
        ...
        alisa "*икая* А хороший ты парень Влад"
        name_vladM "Ты тоже нич *ик* ё, такая"
        alisa "А ты девственник?"
        name_vladM "Я?{w} Да я ебался больше чем ты живёшь"
        alisa "Вау{w}, значит покажешь мне как это?"
        ...
        th "Утром солнце светило особенно ярко{w}, я хотел приобнять Славю, но со мной в мешке её не
        оказалось"
        ...
        old "Привет ребята, вы новенькие?"
        ...
        alisa "О{w}, привет парни{w}, новенькие?"
        ...
        slYA "Это прекрасно{w}, тогда пройдём со мной к Ольге Дмитриевне{w}, она ознакомит вас со всем"
        th "Мы сами не верили в то что делаем, но выбора у нас особо не было"
        old "Здравствуйте ребята{w}, теперь вы пионеры, прошу ознакомиться с правилами и расписанием"
        ...
        alisa "Ооооо{w}, ебать вы поспать конечно пацаны{w}, и не кури здесь Влад{w}, Ольга увидит, пизды даст"
        ...
        old "Мальчики{w}, вы проснулись?{w} Можно войти?"
        name_ii "Входите"
        old "Я вам вчера не ту карту дала{w}, вот карта, которая до Байкала вас доведёт"
        name_vladP "*шёпотом* ты её тоже трахал Влад?"
        name_vladM "*шёпотом* раз восемь"
        name_ura "Спасибо огромное, ну нам пора"
        old "Может сходите на завтрак"
        name_ii "НЕТ!{w} НАМ ПОРА"
        old "Ну как хотите, пойдём{w}, мы вас проводим"
